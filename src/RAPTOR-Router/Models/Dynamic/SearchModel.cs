...
namespace RAPTOR_Router.Models.Dynamic
{
    ...
    public class SearchModel
    {
        ...
        private void SetTripReachInRound(Stop stop, Trip trip, DateOnly tripDate, Stop otherEndStop, DateTime reachTime, int round)
        {
        ...
        /// <param name="round">The round in which to set the reach</param>
        private void SetBikeTripReachInRound(BikeStation reachedFrom, BikeStation reachedTo, DateTime reachTime, int round)
        {
